...
class SqlServer:
    ...
    def run_tests_and_insert_into_sql_server(Test, collection_name):
        ...
        cursor.execute(f"INSERT INTO {collection_name} (type, errors_len, errors, failures, skipped, messages, tests_run, was_successful, time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
...
# مثال استفاده:
# اگر تست‌ها موفقیت‌آمیز بودند، نتیجه True خواهد بود؛ در غیر این صورت False
# result = SqlServer.run_tests_and_insert_into_sql_server(Test_Login, 'test_login')
# print(result)
